    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div class="lg:order-1 flex flex-col justify-center">
                        <div class="flex flex-col space-y-4">
                            ...
                            <div class="flex flex-col space-y-2">
                                <a href="/login" class="w-full lg:w-1/2 bg-blue-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Get Your Headshots</a>
                    ...
                    <div class="lg:order-2">
                        <img src="{{ asset('storage/images/hero.png') }}" alt="AI Headshot Illustration" class="rounded-lg object-cover w-full h-auto lg:h-full" />
                    </div>
                </main>
